...
*/
Vector2.prototype.setAll = function(x, y) {
	"use strict";
...
* @param other - the other vector in the addition.
*/
Vector2.prototype.addSelf = function (other) {
	"use strict";
...
*/
Vector2.prototype.addOut = function (other, out) {
	"use strict";
 ...
 */
Vector2.prototype.angleBetween = function (other, isDegree) {
	"use strict";
 ...
 * @return - the angle to the other vector.
 */
Vector2.prototype.angleBetween2 = function (other, isDegree) {
	"use strict";
...
**/
Vector2.prototype.subtractSelf = function (other) {
	"use strict";
...
**/
Vector2.prototype.subtractOut = function(other, out) {
	"use strict";
...
**/
Vector2.prototype.multSelf = function(scalar) {
	"use strict";
...
*/
Vector2.prototype.multOut = function (scalar, out) {
	"use strict";
...
* Multiply this vector by a scalar, and store the result in yourself.
**/
Vector2.prototype.scaleSelf = function(scalar) {
	"use strict";
...
* Multiply this vector by a scalar, and store the result in yourself.
**/
Vector2.prototype.scaleOut = function(scalar, out) {
	"use strict";
...
* magnitude as this vector, but in the opposite direction.
**/
Vector2.prototype.negativeSelf = function () {
	"use strict";
 ...
 * @param  {Vector2} out where to put the result of the calculation.
 */
Vector2.prototype.negativeOut = function (out) {
	"use strict";
...
*/
Vector2.prototype.angleDeg = function(){
	"use strict";
...
* @return:Vector2 - The vector instance this was called on, updated accordingly
*/
Vector2.prototype.shift = function(shiftX, shiftY){
	"use strict";
...
* @return:Vector2 - A new Vector2 which is the rotated version of the original
*/
...
* @param angle:Number - The angle in degrees to rotate by
* @return:Vector2 - The rotated instance of the Vector2 this was called on
*/
 ...
 */
Vector2.prototype.rotateOut = function (angle, out) {
	"use strict";
 ...
 * @param  {Vector2} out the vector to copy to.
 */
Vector2.prototype.copyOut = function(out) {
	"use strict";
